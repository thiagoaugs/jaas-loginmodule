...
import br.com.systemglass.security.interfaces.IGrupoBeanRemote;
import br.com.systemglass.security.interfaces.IJaasBeanRemote;

/**
 * @author desenv.systemglass
 *
 */
	...
	private List<String> getGrupos() {
		...
		try {
			...
			IGrupoBeanRemote ejb = (IGrupoBeanRemote) ctx
					.lookup("ejb:admin/admin-ejb/GrupoBean!br.com.systemglass.security.interfaces.IGrupoBeanRemote");
